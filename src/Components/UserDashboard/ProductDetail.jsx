          ...
          <div className="lg:w-3/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <h2 className="text-sm title-font text-green-800 tracking-widest">
                <span className="line-through">Rs. {product.price}</span> Rs.
                {appState.data.price -
                  (appState.data.price * appState.data.discount) / 100}
              </h2>
              <span className="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">
                {appState.data.discount}% Off
              </span>
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                <div className="flex">
                  <span className="mr-3">
                    Viewed by : {appState.data.viewBy}
                  </span>
                </div>
                <div className="flex ml-6 items-center">
                  <span className="mr-3">In stock : </span>
                  <div className="relative">{appState.data.inStock} items</div>
                </div>
              </div>
              <TextArea
            ...
            <div className="flex gap-2 justify-between w-full">
              <Button className="bg-black hover:bg-slate-900 text-white font-bold my-3 w-full rounded-full">
                Buy Now
              </Button>
              <Button className="bg-blue-600 hover:bg-slate-900 text-white font-bold my-3 w-full rounded-full">
                Add to cart
              </Button>
            </div>
          </div>
